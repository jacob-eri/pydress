...
def calc_vols2(vols, spec_calc, bins, integrate=True, quiet=True, **kwargs):
    ...
    spec = _get_empty_spec2(vols, bins, integrate)
    ...
    for i in range(vols.nvols):
        ...
        s = calc_single_vol2(vols, index, spec_calc, bins=bins, **kwargs)
...
def calc_single_vol2(vols, index, spec_calc, **kwargs):
...
def _get_empty_spec2(vols, bins, integrate):
