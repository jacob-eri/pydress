"""Interface to voxelized viewing cones generated with LINE21."""
...
class ViewingCone(object):
    ...
    def __init__(self, name):
        ...
        if name.lower() == 'km11' or name.lower() == 'tofor':
            file_path = '/home/sconroy/LOS/M11/TOFOR'
        elif name.lower() == 'ab':
            file_path = '/home/fbinda/LOS/afterburner/ABdrf.out'
        elif name.lower() == 'km9':
            file_path = '/home/jeriks/LOS/KM9_2021.out'
        elif name.lower() == 'km12':
            file_path = '/home/sconroy/LOS/KM12/M12.out'
        else:
            file_path = name
